...
const listarParcela2 = (modeloParcela2, baseComissoes, baseAssessor, ano,mes,apelido,baseCobranca) => {
    ...
    if(modeloParcela2 === 'cobranca2019') return cobranca2019(baseCobranca, ano, mes)
