...
const coeficiente = (dataEntrou,dataSaiu,mes) =>{
    if(dataEntrou.toString().includes('/') && dataSaiu.toString().includes('/') || dataEntrou.toString().includes('-') && dataSaiu.toString().includes('-')){
        ...
        if(entrouEsseMes && !saiuEsseMes){
            ...
            const calculoCoeficiente = (new Date(calculoUltimoDia(ano,mes) - data).getDate())/(new Date(calculoUltimoDia(ano,mes))).getDate()
            if(calculoCoeficiente >= 0 ) return calculoCoeficiente
            return 0
            ...
            const calculoCoeficiente = (new Date(data).getDate())/(new Date(calculoUltimoDia(ano,mes))).getDate()
            if(calculoCoeficiente >= 0 ) return calculoCoeficiente
            return 0
        }if(saiuEsseMes && entrouEsseMes){
            ...
            const calculoCoeficiente = ((new Date(dataSaida).getDate() - new Date(dataEntrada).getDate())+1)/(new Date(calculoUltimoDia(ano,mes))).getDate()
            if(calculoCoeficiente >= 0 ) return calculoCoeficiente
            return 0
        }if(continuaNaZiro){
            return 1
