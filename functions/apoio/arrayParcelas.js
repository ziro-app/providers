    ...
    for(let i = mesInicio; i <= mesFim; i++){
        ...
        if(dataSaiu === '-' && stringDate(dataEntrou) <= new Date(2020,i) || stringDate(dataSaiu) <= new Date(2020, i) && stringDate(dataEntrou) >= new Date(2020,i)){
            ...
            listPagamentos.push({
                ...
                mes: i ,
                apelido: apelido,
                parcela1: searchReajuste(apelido,new Date(2020,i), baseReajuste, parcela1, 'parcela1',baseComissoes, baseAssessor, i),
                parcela2: searchReajuste(apelido,new Date(2020,i), baseReajuste, parcela2, 'parcela2',baseComissoes, baseAssessor, i),
            })
        }else{
            listPagamentos.push([])
        }
